...
local hitboxSliders = {
    ...
    makeSlider("BlockHitBox", 1, 10, hitboxValues.BlockHitBox, function(v) updateHitbox("BlockHitBox", v) end),
    makeSlider("DiveHitBox", 1, 10, hitboxValues.DiveHitBox, function(v) updateHitbox("DiveHitBox", v) end),
    makeSlider("RecHitBox", 1, 10, hitboxValues.RecHitBox, function(v) updateHitbox("RecHitBox", v) end),
    makeSlider("TopHitBox", 1, 10, hitboxValues.TopHitBox, function(v) updateHitbox("TopHitBox", v) end),
}
...
print("[J Hub Hub] Hitbox adjustment sliders loaded (real-time).")
